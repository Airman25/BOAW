...
//settings
func GetRoom3() []RoomObject {
	return []RoomObject{
		//languages
		{float64(screenWidth)/2 - buttonwidth, float64(screenHeight)/2 - buttonheight*3, buttonwidth, buttonheight, buttonscaling, 501, load.ImageText("button", "English", buttonwidth, buttonheight, "", 0, 0)},
		{float64(screenWidth) / 2, float64(screenHeight)/2 - buttonheight*3, buttonwidth, buttonheight, buttonscaling, 502, load.ImageText("button", "Русский", buttonwidth, buttonheight, "", 0, 0)},
		//buttons
